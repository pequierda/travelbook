/**
 * Vercel API Route: Upstash HGET command
 * Securely handles Redis HGET operations using environment variables
 */
...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        const response = await fetch(`${upstashUrl}/hget/${args[0]}/${args[1]}`, {
            headers: { 
