/**
 * Vercel API Route: Upstash HGETALL command
 * Securely handles Redis HGETALL operations using environment variables
 */
...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        const response = await fetch(`${upstashUrl}/hgetall/${args[0]}`, {
            headers: { 
